...
//    Blynk.logEvent("button_pressed", device_MAC+"/t"+"TV_CH12"+"/t"+localTime) ;
    Data_to_Sheets(No_of_Parameters,  device_MAC, "Button_pressed", "TV_PRESET2");
...
//    Blynk.logEvent("button_pressed", device_MAC+"/t"+"TV_CH13"+"/t"+localTime) ;
    Data_to_Sheets(No_of_Parameters,  device_MAC, "Button_pressed", "TV_PRESET3");
...
//    Blynk.logEvent("button_pressed", device_MAC+"/t"+"TV_CH_PLUS"+"/t"+localTime) ;
...
//    Blynk.logEvent("button_pressed", device_MAC+"/t"+"TV_VOL_PLUS"+"/t"+localTime) ;
...
//    Blynk.logEvent("button_pressed", device_MAC+"/t"+"TV_CH_MINUS"+"/t"+localTime) ;
...
//    Blynk.logEvent("button_pressed", device_MAC+"/t"+"TV_VOL_MINUS"+"/t"+localTime) ;
...
//      Blynk.logEvent("button_pressed", device_MAC+"/t"+"AC_HEAT_ANALOG"+"/t"+localTime) ;
...
//      Blynk.logEvent("button_pressed", device_MAC+"/t"+"AC_COOL_ANALOG"+"/t"+localTime) ;
...
//      Blynk.logEvent("button_pressed", device_MAC+"/t"+"NETFLIX"+"/t"+localTime) ;
...
//      Blynk.logEvent("button_pressed", device_MAC+"/t"+"YOUTUBE"+"/t"+localTime) ;
